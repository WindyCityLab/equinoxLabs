...
##The Lab
The purpose of this lab is to build onto our existing Smart Cube. This new smart cube will have all existing functionality, but be able to:

* Play music of your choosing when the alarm goes off, instead of using the buzzer 
